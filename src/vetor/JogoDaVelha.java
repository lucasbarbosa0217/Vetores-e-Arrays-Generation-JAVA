...
public class JogoDaVelha {
	...
	public static void main(String[] args) {
		...
		do {
			...
			int placeIa[] = inteligenciaArtificial(game);
			if (placeIa[0] > 9) {
				canPlace = false;
				do {
	...
	public static int[] inteligenciaArtificial(char[][] game) {

		for (int i = 0; i < 3; i++) {
			if (game[i][0] == 'O' && game[i][1] == 'O' && game[i][2] == ' ') {
				return new int[] { i, 2 };
			}
			if (game[i][0] == 'O' && game[i][2] == 'O' && game[i][1] == ' ') {
				return new int[] { i, 1 };
			}
			if (game[i][1] == 'O' && game[i][2] == 'O' && game[i][0] == ' ') {
				return new int[] { i, 0 };
			}
			if (game[0][i] == 'O' && game[1][i] == 'O' && game[2][i] == ' ') {
				return new int[] { 2, i };
			}
			if (game[0][i] == 'O' && game[2][i] == 'O' && game[1][i] == ' ') {
				return new int[] { 1, i };
			}
			if (game[1][i] == 'O' && game[2][i] == 'O' && game[0][i] == ' ') {
				return new int[] { 0, i };
			}
		}
		...
		if (game[0][0] == 'O' && game[2][2] == 'O' && game[1][1] == ' ') {
			return new int[] { 1, 1 };
		}
		if (game[1][1] == 'O' && game[2][2] == 'O' && game[0][0] == ' ') {
			return new int[] { 0, 0 };
		}
		if (game[0][2] == 'O' && game[1][1] == 'O' && game[2][0] == ' ') {
			return new int[] { 2, 0 };
		}
		if (game[0][2] == 'O' && game[2][0] == 'O' && game[1][1] == ' ') {
			return new int[] { 1, 1 };
		}
		if (game[1][1] == 'O' && game[2][0] == 'O' && game[0][2] == ' ') {
			return new int[] { 0, 2 };
		}
